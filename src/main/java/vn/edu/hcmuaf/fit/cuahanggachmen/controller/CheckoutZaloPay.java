...
@WebServlet(name = "CheckoutZaloPay", value = "/checkoutzalo")
public class CheckoutZaloPay extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(status.equals("-49")){
            ...
            order.setPayment("Thanh toán momo");
            ...
            if(lastRowId <= 0) {
                ...
                if(rowCount == c.getItems().size()) {
                    ...
                    request.setAttribute("payment", "Thanh toán zaloPay");
