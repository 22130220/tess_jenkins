    ...
    <div class="content grid-item content-grid">
        <div class="main-grid">
            <nav class="navbar tag-line _4c _1r">
                <div class="nav-back-prev">
                    <div class="breadcumb">
                        ...
                        <a href="#" class="f-bold f-s-25 breadcumb-text">Quản lý Vouchers</a>
                    </div>
                </div>
            ...
            <div class="product-table table _4c _6r">
                <table id="vouchers" class="display" style="width:100%">
                    <thead>
                    <tr>
                        <th>Id</th>
                        <th>Mã</th>
                    ...
                    <div class="modal-content-content">
                        <div class="modal__content">
                            <div class="fui-basic-input" style="width: 100%">
                                <label for="add_code" class="f-bold f-s-14 f-cl-black">Mã</label>
                                <input type="text" name="add_code" placeholder="" class="input input-bordered f-s-14" style="width: 100%" id="add_code" autocomplete="off" required/>
                            </div>
                            <div class="fui-basic-input" style="width: 100%">
                                <label for="add_price" class="f-bold f-s-14 f-cl-black">Giá giảm</label>
                                <input type="text" name="add_price" placeholder="" class="input input-bordered f-s-14" style="width: 100%" id="add_price" autocomplete="off" required/>
                            </div>
                            <div class="fui-basic-input" style="width: 100%">
                                <label for="add_expiredate" class="f-bold f-s-14 f-cl-black">Ngày hết hạn</label>
                                <input type="datetime-local" name="add_expiredate" placeholder="" class="input input-bordered f-s-14" style="width: 100%" id="add_expiredate" autocomplete="off" required/>
                            </div>
                            <div class="fui-basic-input" style="width: 100%">
        ...
        <div class="modal__overlay" tabindex="-1" data-micromodal-close>
            <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
                ...
                <div class="modal-content-content">
                    <div class="modal__content">
                        <div class="fui-basic-input" style="width: 100%">
                            <label for="update_code" class="f-bold f-s-14 f-cl-black">Mã</label>
                            <input type="text" name="update_code" placeholder="" class="input input-bordered f-s-14" style="width: 100%" id="update_code" autocomplete="off" required/>
                        </div>
                        <div class="fui-basic-input" style="width: 100%">
                            <label for="update_price" class="f-bold f-s-14 f-cl-black">Giá giảm</label>
                            <input type="text" name="update_price" placeholder="" class="input input-bordered f-s-14" style="width: 100%" id="update_price" autocomplete="off" required/>
                        </div>
                        <div class="fui-basic-input" style="width: 100%">
                            <label for="update_expiredate" class="f-bold f-s-14 f-cl-black">Ngày hết hạn</label>
                            <input type="datetime-local" name="update_expiredate" placeholder="" class="input input-bordered f-s-14" style="width: 100%" id="update_expiredate" autocomplete="off" required/>
                        </div>
                        <div class="fui-basic-input" style="width: 100%">
...
<script src="/assets/js/voucher_ajax.js"></script>
</body>
