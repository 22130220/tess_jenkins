...
<header class="header fixed">
    <div class="main-content">
        <div class="body">
            ...
            <div class="user-menu">
                <div class="user-info">
                    <img src="https://vcdn1-giadinh.vnecdn.net/2022/05/03/gai-beo-1-2-6866-1651575364.jpg?w=460&h=0&q=100&dpr=2&fit=crop&s=DpsrLTd56Z7lc77C9uK-yA" alt="Avatar" class="avatar">
                    <span class="username">Trương Diễm</span>
                </div>
                <div class="dropdown">
                    <ul>
                        <li><a href="./hoso.html">Tài khoản của tôi</a></li>
                        <li><a href="./lichsudonhangthanhcong.html">Đơn mua</a></li>
...
<div class="container">
    ...
    <aside class="sidebar">
        <div class="small-profile">
            <div class="avatar">
                <img src="https://vcdn1-giadinh.vnecdn.net/2022/05/03/gai-beo-1-2-6866-1651575364.jpg?w=460&h=0&q=100&dpr=2&fit=crop&s=DpsrLTd56Z7lc77C9uK-yA" alt="Avatar">
            </div>
            <div class="info">
                <span class="username">truongdiem123</span>
        ...
        <ul>
            ...
            <a href="./hoso.html"><li >Hồ Sơ</li></a>
            ...
            <hr>
            <a href="./home.html"><li>Quay về trang chủ</li></a>
    ...
    <main class="profile">
        <div class="danhmucdautien">
            ...
            <a href="./lichsudonhangthanhcong.html"><div class="DH "> Đơn đã giao thành công</div></a>
            <a href=""> <div class="DH active">  Đơn đã hủy</div></a>
        </div>



        <div class="noidungcacdonhang">
            <div class="cacsanpham">
                <div class="hoanthanh"><b>ĐƠN ĐÃ HỦY</b></div>
                <hr>

                <div class="sanpham">
                    <div class="hinhanhcuacaigach">
                        <img src="https://thegioigachre.com/media/thumb/900x900/1/images/product/08568_gach-60x60-lat-nen-gia-re-2.jpg.jpg" alt="">
                    </div>


                    <div class="chitietsanpham">
                        <div class="tengachmen1">GẠCH MEN SIÊU ĐẸP CHO SÀN NHÀ</div>
                        <div class="loaigachmen1">Loại gạch: Lát sàn</div>
                        <div class="soluong1">x4</div>
                    </div>
                    ...
                    <a class="mualaine" href="" style="display: inline-block;">
                        <div class="mualai">Đặt lại</div>
                    </a>
                </div>
