...
<div class="login-form">
  <div class="alpha">
    <div id="qr" class="login-icon">
      <img src="${dataUri}" alt="Fast UI"/>
<%--      <i class="fa-solid fa-user-tie log-i"></i>--%>
    </div>
  </div>
  <div class="omega">
    <form action="totp" method="post" class="form">
      ...
      <p class="totp_notice f-s-14 f-cl-black f-regular">
        Hãy sử dụng ứng dụng xác thực 2 yếu tố để bảo mật tài khoản của bạn, như Google Authenticator, Microsoft Authenticator hoặc Authy.
      </p>
